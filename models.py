...
class GKT(nn.Module):
    ...
    def __init__(self, concept_num, hidden_dim, embedding_dim, edge_type_num, graph_type, graph=None, graph_model=None, dropout=0.5, bias=True, binary=False, has_cuda=False):
        ...
        assert graph_type in ['Dense', 'Transition', 'DKT', 'PAM', 'MHA', 'VAE', 'Predefined']
        self.graph_type = graph_type
        if graph_type in ['Dense', 'Transition', 'DKT', 'Predefined']:
        ...
        if graph_type in ['Dense', 'Transition', 'DKT', 'PAM', 'Predefined']:
    ...
    def _agg_neighbors(self, tmp_ht, qt):
        ...
        if self.graph_type in ['Dense', 'Transition', 'DKT', 'PAM', 'Predefined']:
